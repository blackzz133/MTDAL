...
def temporal_signal_split2(data_iterator, train_ratio: float=0.8) -> Tuple[Discrete_Signal, Discrete_Signal]:
    r""" Function to split a data iterator according to a fixed ratio.
    ...
    if type(data_iterator) == StaticGraphTemporalSignal:
        ...
        val_iterator = StaticGraphTemporalSignal(data_iterator.edge_index,
                                                  data_iterator.edge_weight,
                                                  data_iterator.features[train_snapshots:val_snapshots],
                                                  data_iterator.targets[train_snapshots:val_snapshots])

        test_iterator = StaticGraphTemporalSignal(data_iterator.edge_index,
                                                  data_iterator.edge_weight,
                                                  data_iterator.features[val_snapshots:],
                                                  data_iterator.targets[val_snapshots:])
        ...
        val_iterator = DynamicGraphTemporalSignal(data_iterator.edge_indices[train_snapshots:val_snapshots],
                                                    data_iterator.edge_weights[train_snapshots:val_snapshots],
                                                    data_iterator.features[train_snapshots:val_snapshots],
                                                    data_iterator.targets[train_snapshots:val_snapshots])

        test_iterator = DynamicGraphTemporalSignal(data_iterator.edge_indices[val_snapshots:],
                                                   data_iterator.edge_weights[val_snapshots:],
                                                   data_iterator.features[val_snapshots:],
                                                   data_iterator.targets[val_snapshots:])
        ...
        val_iterator = DynamicGraphStaticSignal(data_iterator.edge_indices[train_snapshots:val_snapshots],
                                                  data_iterator.edge_weights[train_snapshots:val_snapshots],
                                                  data_iterator.feature,
                                                  data_iterator.targets[train_snapshots:val_snapshots])

        test_iterator = DynamicGraphStaticSignal(data_iterator.edge_indices[val_snapshots:],
                                                 data_iterator.edge_weights[val_snapshots:],
                                                 data_iterator.feature,
                                                 data_iterator.targets[val_snapshots:])
    ...
    if type(data_iterator) == StaticGraphTemporalSignalBatch:
        ...
        val_iterator = StaticGraphTemporalSignalBatch(data_iterator.edge_index,
                                                      data_iterator.edge_weight,
                                                      data_iterator.features[train_snapshots:val_snapshots],
                                                      data_iterator.targets[train_snapshots:val_snapshots],
                                                      data_iterator.batches)
        ...
        val_iterator = DynamicGraphTemporalSignalBatch(data_iterator.edge_indices[train_snapshots:val_snapshots],
                                                       data_iterator.edge_weights[train_snapshots:val_snapshots],
                                                       data_iterator.features[train_snapshots:val_snapshots],
                                                       data_iterator.targets[train_snapshots:val_snapshots],
                                                       data_iterator.batches[train_snapshots:val_snapshots])

        test_iterator = DynamicGraphTemporalSignalBatch(data_iterator.edge_indices[val_snapshots:],
                                                        data_iterator.edge_weights[val_snapshots:],
                                                        data_iterator.features[val_snapshots:],
                                                        data_iterator.targets[val_snapshots:],
                                                        data_iterator.batches[val_snapshots:])
        ...
        val_iterator = DynamicGraphStaticSignalBatch(data_iterator.edge_indices[train_snapshots:val_snapshots],
                                                     data_iterator.edge_weights[train_snapshots:val_snapshots],
                                                     data_iterator.feature,
                                                     data_iterator.targets[train_snapshots:val_snapshots],
                                                     data_iterator.batches[train_snapshots:val_snapshots])

        test_iterator = DynamicGraphStaticSignalBatch(data_iterator.edge_indices[val_snapshots:],
                                                      data_iterator.edge_weights[val_snapshots:],
                                                      data_iterator.feature,
                                                      data_iterator.targets[val_snapshots:],
                                                      data_iterator.batches[val_snapshots:])
