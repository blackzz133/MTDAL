...
import argparse
from victim import Encovid_victim_model
from attack import Encovid_attack_model
import os
from config import *
...
def main():
    ...
    victim_type = 'A3TGCN'
    print(victim_type)
    victim_model = Encovid_victim_model(args, victim_type)
    #exit()
    ...
    #victim_model = None
    print('attack_model')
    #attack_type = 'Kcenter'#'Kcenter'#ALTG,  #Random MTTAL
    attack_type = 'Random'
    #需要获取
    #attack_model, result, result2, result3, result4, gcn_result =  Encovid_attack_model(args, victim_model, attack_type, device)
    ...
    attack_model, all_loss = Encovid_attack_model(args, victim_model, attack_type, device)
